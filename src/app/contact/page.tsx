          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@pdftools.com" className="text-blue-600 hover:text-blue-800">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="https://github.com/Vinay5095/PDF-Tools-Web-Application/discussions" 
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="https://docs.pdftools.com" 
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">Are my files secure?</h4>
                    <p className="text-sm text-gray-600">
                      Yes! All processing happens locally in your browser. Files are never uploaded to our servers.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">Is there a file size limit?</h4>
                    <p className="text-sm text-gray-600">
                      Free users can process files up to 25MB. Premium users enjoy higher limits.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">Do I need to create an account?</h4>
                    <p className="text-sm text-gray-600">
                      No account required for basic features. Premium features require registration.
                    </p>
                  </div>
                </CardContent>
              </Card>
